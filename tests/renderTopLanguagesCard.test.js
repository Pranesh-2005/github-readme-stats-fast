...
describe("Test renderTopLanguages", () => {
  ...
  it("should show proper stats format", () => {
    ...
    // Upstream's `stats_format: "bytes"` assertions are omitted: that option
    // is built on the formatBytes() helper, which this fork does not have.
    // Only "percentages" (the default, asserted above) is supported here.
  });
});
